...
class GenreServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->genre = new GenreService(new GenreRepository(new Genre()));
    }
    ...
    public function testFind()
    {
        ...
        $genre = $this->genre->getById($uuid);
        self::assertInstanceOf(GenreResource::class, $genre);
    }
}
