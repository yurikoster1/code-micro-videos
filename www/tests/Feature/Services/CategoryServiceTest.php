...
class CategoryServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->category = new CategoryService(new CategoryRepository(new Category()));
    }
    ...
    public function testFindFail()
    {
        ...
        $this->category->getById(Str::uuid());
    }
    public function testFind()
    {
        $uuid = Str::uuid();
        factory(Category::class)->create(['id' => $uuid, 'name' => 'Teste 1']);
        $category = $this->category->getById($uuid);
        self::assertInstanceOf(CategoryResource::class, $category);
    }
}
